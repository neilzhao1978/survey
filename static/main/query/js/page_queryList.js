...
$(function(){
    ...
    $('#tbContent').bootstrapTable({
        ...
        columns:[[
            ...
            {field:'answerCount',align:'center',width:50,title:'有效回复',class:'panel-reply',formatter:validQueryNum,sortable:true},
            {field:'result',align:'center',width:50,title:'看板结果',class:'panel-result',formatter:panelResult,sortable:true},
