...
select SURVEY_ID,REPLYER_POSITION  ,ai.IMAGE_ID,IMAGE_NAME,THUMB_URL,BRAND,i.MODUEL model,STYLE_KEYWORD,TEXTURE,YEAR from answer a left join ANSWER_IMAGE  ai on a.answer_id = ai.answer_id left join image i on ai.image_id = i.image_id; 
...
from SURVEY_ANSWER_ALL_INFO  group by SURVEY_ID,IMAGE_ID